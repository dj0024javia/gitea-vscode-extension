...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
    ...
    registerAuthCommands(context, auth, api, repoManager, prProvider, ciProvider, statusBar);
    ...
    await vscode.commands.executeCommand('setContext', 'gitea.authenticated', !!session);
}
